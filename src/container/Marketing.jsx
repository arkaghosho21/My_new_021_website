...
function Marketing() {
    return (
        <div>
            <section class="mx-auto py-12 text-black sm:py-16 lg:p-20 bg-zinc-200">
                <div class="mx-auto px-6 sm:px-8 lg:px-12">
                    <div class="row-gap-12 grid grid-cols-1 lg:grid-cols-2">
                        <div class="flex flex-col">
                            <div class="">
                                <h2 class="font-sans text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl"><span class="leading-snug">The Management Masterclass</span></h2>
                                <p class="mt-6 text-lg text-gray-700">I don't even want to wear a hat. The urn of the poisoned quiver of the house. Porta porttitor not laoreet if not augue porttitor.</p>
                            </div>

                            <div class="group relative mt-8 w-full overflow-hidden rounded-xl">
                                <div class="inset-0 bg-blue-700">
                                    <img class="max-w-full object-cover opacity-10 transition-all duration-300 ease-in-out group-hover:opacity-80" src="https://images.unsplash.com/photo-1575936123452-b67c3203c357?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
                                </div>
                        ...
                        <div class="mt-10 lg:pl-16">
                            <div class="text-white">
                                ...
                                <div class="group relative mb-4 overflow-hidden hover:scale-110 rounded-md border bg-black py-10 px-8 shadow-lg transition-all duration-200 ease-in-out">
                                    ...
                                    <p class="mt-4">Even the clinic, the restaurant Lorem, ipsum dolor sit amet consectetur adipisicing elit. Facere ducimus dolorum molestiae? Rerum culpa id vitae adipisci qui suscipit inventore, labore quis, praesentium autem cupiditate. is in the cartoon. My massauris amet lorem fusce. It's aimed at the kids as always.</p>
