            ...
            <div className="container flex flex-wrap p-8 mx-auto xl:px-0 lg:gap-10 lg:flex-nowrap">
                <div className="flex items-center justify-center w-full lg:w-1/2">
                    <div>
                        <img
                            alt="Benefits"
                            src="https://web3templates.com/img/assets/feature-illustration.png"
                            loading="lazy"
                        />
                    </div>
                </div>
                <div className="flex flex-wrap items-center w-full lg:w-1/2">
                    <div>
                        <div className="flex flex-col w-full mt-4">
                            ...
                            <p className="max-w-2xl py-4 text-lg leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-800">
                        ...
                        <div className="w-full mt-5">
                            <div className="flex items-start mt-8 space-x-3">
                                ...
                                <div>
                                    <h4 className="text-xl font-medium text-gray-800 dark:text-gray-500">
