...
function Navbar() {
    return (
        <div>
            {/* <nav className='w-full px-10 py-6 dark:bg-neutral-600' >
            ...
            <header class="w-full shadow bg-slate-500">
                <div class="mx-auto pr-4 pl-4 flex max-w-full flex-col py-4 sm:flex-row sm:items-center sm:justify-between">
                    {/* <div className='py-4'> */}
                    ...
                    <nav aria-label="Header Navigation" class="peer-checked:block hidden pl-2 py-6 sm:block sm:py-0">
                        <ul class="flex flex-col justify-end  gap-y-4 sm:flex-row sm:gap-x-8">
                            <li class="mt-2 sm:mt-0"><a to="/" class="rounded-xl px-6 py-2 font-medium text-black-600 hover:bg-slate-600 hover:text-white" href="#">Pricing</a></li>
                            <li class="mt-2 sm:mt-0"><a to="/bloges" class="rounded-xl border-black-600 px-6 py-2 font-medium text-black-600 hover:bg-slate-600 hover:text-white" href="#">Demo</a></li>
                            <li class="mt-2 sm:mt-0"><a to="/marketing" class="rounded-xl border-black-600 px-6 py-2 font-medium text-black-600 hover:bg-slate-600 hover:text-white" href="#">Support</a></li>
                            <li class="mt-2 sm:mt-0"><a to="/middle" class="rounded-xl border-2 border-black-600 px-6 py-2 font-medium text-black-600 hover:bg-slate-800 hover:text-white" href="#">Login</a></li>
                        </ul>
                    </nav>
                </div>
                {/* </div> */}
